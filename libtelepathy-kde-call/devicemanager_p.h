...
public:
     ...
     */
    QGst::ElementPtr newAudioInputElement();
     ...
     */
    QGst::ElementPtr newAudioOutputElement();
     ...
     */
    QGst::ElementPtr newVideoInputElement();
     ...
     */
    QGst::Ui::VideoWidget *newVideoWidget(QWidget *parent = 0);
